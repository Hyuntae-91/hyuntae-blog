...
> 2. [The System AI 'Works' In — Engineering and Verification Ownership](/ko/blog/ai-adoption-journey-2-engineering)
> 3. [When the AI Server Goes Down, I Turn Into an Idiot Too — Local LLMs and AI Dependence](/ko/blog/ai-adoption-journey-3-local-llm)
> 4. [Chasing AI, Alongside AI — Even How I Learn Has Changed](/ko/blog/ai-adoption-journey-4-learning)
...
*Before* clarify ever throws a question, prefill searches both the codebase and an LLM wiki I'd built myself — an Obsidian-based store of project domain knowledge and policy decisions (more on this in [Part 2](/ko/blog/ai-adoption-journey-2-engineering)) — and **pre-fills whatever the code and the record can already answer** straight into the spec. The core idea is separation: **splitting "questions the code can answer" from "questions only a human can answer," and routing the former to an automatic resolution step.**
...
> **Continue reading:** [② The System AI 'Works' In — Engineering and Verification Ownership](/ko/blog/ai-adoption-journey-2-engineering)
